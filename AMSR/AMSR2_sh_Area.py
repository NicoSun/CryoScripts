...
class NSIDC_area:
	...
	def masksload(self):
		...
		'''
		filename = '/home/nico/cryodata/AMSR/Masks/south/AMSR2_land_sh.dat'
		self.landmask = CryoIO.openfile(filename,np.uint8)
		
		filename = '/home/nico/cryodata/AMSR/Masks/south/AMSR2_latitude_sh.dat'
		self.latmask = CryoIO.openfile(filename,np.int8)
		
		filename = '/home/nico/cryodata/AMSR/Masks/south/AMSR2_longitude_sh.dat'
		self.lonmask = CryoIO.openfile(filename,np.int8)
		
		self.maskview(self.latmask)
		plt.show()
...
# =============================================================================
	...
	def maskview(self,icemap):
		...
		plt.imshow(icemap, interpolation='nearest', vmin=-60, vmax=-50, cmap=plt.cm.jet)
