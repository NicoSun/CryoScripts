...
# =============================================================================
    ...
    def exportdata(self):
        CryoIO.csv_columnexport(f'{self.webpath}/NSIDC_Area/Data/Arctic_NSIDC_Area_NRT.csv',
            [self.CSVDatum,self.CSVArea,self.CSVExtent,self.CSVCompaction,self.CSVArea_High,self.CSVExtent_High])
        CryoIO.csv_columnexport(f'{self.webpath}/NSIDC_Area/Data/Regional_NRT.csv',
        ...
        CryoIO.csv_columnexport(f'{self.webpath}/NSIDC_Area/Data/Regional_NRT_extent.csv',
