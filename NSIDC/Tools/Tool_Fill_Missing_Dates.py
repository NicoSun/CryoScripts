...
# =============================================================================
	...
	def gapyear(self):
		...
		filepath = f'/home/nico/Cryoscripts/NSIDC/DataFiles/{self.year}'
		filename = 'NSIDC_{}{}{}.npz'.format(self.year,self.stringmonth,self.stringday)
		
		filenamePlus1 = 'NSIDC_{}0301.npz'.format(self.year)
		filenameMinus1 = 'NSIDC_{}0228.npz'.format(self.year)
