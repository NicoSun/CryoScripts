...
class Simpleviewer:
    ...
    def __init__  (self):
        self.Cdate = CryoIO.CryoDate(2022,6,8) # initilizes a 366 day year
    ...
    def viewloop(self):
        ...
        for count in range (0,self.daycount,1): 
            ...
            if self.mode == 'Mean':
                filename = f'DataFiles/Forecast_{forecast_month}/Forecast_Manual/NSIDC_Mean_{month}{day}.npz'
            elif self.mode == 'Stdv':
                filename = f'DataFiles/Forecast_{forecast_month}/Forecast_SIC_change/NSIDC_SIC_Change_{month}{day}.npz'
            elif self.mode == 'Change':
                filename = f'DataFiles/Forecast_{forecast_month}/Forecast_Stdv/NSIDC_Stdv_{month}{day}.npz'
