...
class ADS_data:
	...
	def __init__  (self):
		...
		self.daycount = 3 #total length: 3469 (end 2021)
...
# 		CryoIO.savebinaryfile(f'temp/AMSR2_meltcount_{self.year}.dat',self.meltcount)
# 		CryoIO.savebinaryfile(f'temp/AMSR2_freezecount_{self.year}.dat',self.freezecount)
# =============================================================================
		#save last available date
		#CryoIO.savebinaryfile('AMSR2_SIT_{}{}{}.dat'.format(self.year,self.stringmonth,self.stringday),icethickess)
		...
		for item in meandict:
			CryoIO.savebinaryfile('temp/AMSR2_SIT_Mean_{}.dat'.format(item),meandict[item])
	...
	def loadfirstday (self,year,month,day):
		...
		self.daycount = 3469 # Jul 2012- Dec 2021
		...
		CryoIO.csv_columnexport('temp_AMSR2_V1.5.csv',[self.CSVDatum,self.CSVVolume,self.CSVThickness])
	...
	def meanlalala(self):
		...
		for count in range (0,365): 
			filename = 'temp/AMSR2_SIT_Mean_{}{}.dat'.format(self.stringmonth,self.stringday)
			filename_out = 'DataFiles/Mean/ADS_Mean_{}{}.dat'.format(self.stringmonth,self.stringday)
			ice = CryoIO.openfile(filename,np.int32)
